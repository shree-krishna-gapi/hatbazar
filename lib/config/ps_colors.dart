...
class PsColors {
  ...
  static const Color _c_main_color = Color(0xFF00AE00);
  static const Color _c_main_light_color = Color(0xFFE5F6D2); //FFF0F1);
  static const Color _c_main_dark_color = Color(0xFF80C342);
