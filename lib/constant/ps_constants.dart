...
class PsConst {
  ...
  //gapi
  static const int REQUEST_CODE__DASHBOARD_REGISTER_FRAGMENT = 2003; //2003
  static const int REQUEST_CODE__DASHBOARD_SELECT_WHICH_USER_FRAGMENT = 2006; //2006

  //


  static const int REQUEST_CODE__DASHBOARD_SEARCH_FRAGMENT = 2007; // 7
  static const int REQUEST_CODE__DASHBOARD_MESSAGE_FRAGMENT = 2008; //8
