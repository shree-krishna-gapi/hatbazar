...
import 'package:hatbazar/provider/chat/get_chat_history_provider.dart';
...
import 'package:hatbazar/ui/chat/dialog/chat_make_offer_dialog.dart';
...
import 'package:hatbazar/ui/rating/entry/rating_input_dialog.dart';
import 'package:hatbazar/utils/ps_progress_dialog.dart';
import 'package:hatbazar/utils/utils.dart';
import 'package:hatbazar/viewobject/chat.dart';
import 'package:hatbazar/viewobject/chat_history.dart';
import 'package:hatbazar/viewobject/chat_user_presence.dart';
import 'package:hatbazar/viewobject/common/ps_value_holder.dart';
import 'package:hatbazar/viewobject/default_photo.dart';
import 'package:hatbazar/viewobject/holder/chat_noti_parameter_holder.dart';
...
import 'package:hatbazar/viewobject/holder/make_offer_parameter_holder.dart';
import 'package:hatbazar/viewobject/holder/reset_unread_message_parameter_holder.dart';
import 'package:hatbazar/viewobject/holder/sync_chat_history_parameter_holder.dart';
...
class _OfferReceivedBoxWithAcceptAndRejectWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final String makeOfferPrice = messageObj.message.replaceAll('\$ ', '');
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(
                    ...
                    children: <Widget>[
                      Text(
                        '${widget.itemData.itemCurrency.currencySymbol} ${widget.itemData.price} ( ${widget.itemData.conditionOfItem.name} )',
                        style: Theme.of(context).textTheme.bodyText1,
                      ),
