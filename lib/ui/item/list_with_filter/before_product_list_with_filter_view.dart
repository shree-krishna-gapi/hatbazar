...
class BeforeProductListWithFilterView extends StatefulWidget {
  const BeforeProductListWithFilterView(
      {Key key,
  ...
  @override
  _BeforeProductListWithFilterViewState createState() =>
      _BeforeProductListWithFilterViewState();
}

class _BeforeProductListWithFilterViewState extends State<BeforeProductListWithFilterView>
