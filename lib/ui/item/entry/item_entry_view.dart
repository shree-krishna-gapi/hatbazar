...
//                                  color: Colors.cyan,
                                  ...
                                  "assets/gapi/${Utils.getString(context, 'current__language')}/district.json"),),
                            ),
                          ],
                        ),
                      )
                                      ...
                                      return
                                        ...
                                        index == municipalityIndex ? InkWell(
                                          ...
                                          onTap: (){
                                            ...
                                            municipalityId = showData[index]['municipalityId'];
                                            Navigator.of(context).pop();
                                          },
                                        ):
                                        InkWell(
...
//                                  color: Colors.cyan,
                              ...
                              DefaultAssetBundle.of(context).loadString("assets/gapi/${Utils.getString(context, 'current__language')}/municipality$z.json"),),
                            ),
                          ],
                        ),
                      )
      ...
      PsDropdownBaseWithControllerWidget(
          ...
          onTap: () async {
            ...
            if (itemLocationResult != null &&
              ...
              setState(() {
                stringStateId = itemLocationResult.id;
//                print('this is -> ${itemLocationResult.id}');
           ...
           final SharedPreferences prefs = await SharedPreferences.getInstance();
            String oldStringStateId = prefs.getString('stringStateIdExisting');
            print('old $oldStringStateId and new $stringStateId');
            if(oldStringStateId != stringStateId) {
              print('changed');
              setState(() {
                districtText = null;
                districtId = 0;
            ...
            if(stringStateId == 'itm_locc91e7fd5ffc739b26951228b0a564569') {
              productStateId = 1;
            }else if (stringStateId == 'itm_loc892e3dbe2fbf07ae7b19455a4e75b28c') {
              productStateId = 2;
            }else if (stringStateId == 'itm_loca7b66748e03d457e976ca63a50e1bde0') {
              productStateId = 3;
            }
            else if (stringStateId == 'itm_loc385aa4e50e654df21b9de999273c0a2c') {
              productStateId = 4;
            }
            else if (stringStateId == 'itm_loc413981c0f76ad269307aaee5eff59517') {
              productStateId = 5;
            }
            else if (stringStateId == 'itm_locb0f1625541a5cdebaf354c027b8462ee') {
              productStateId = 6;
            }
            else if (stringStateId == 'itm_loc94a5a8f9492d0a5ec93165f0f639695d') {
              productStateId = 7;
            }
            prefs.setString('stringStateIdExisting',stringStateId);
          }),
...
// gapi start
      Align(
        ...
        child: Padding(
          ...
          child: Text(
              Utils.getString(context, 'label__district')
          ),
        ),
      ),
      Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              border: InputBorder.none,
              hintText: districtText == null ? Utils.getString(context, 'label__district') : districtText,
              hintStyle: districtText == null ? Theme.of(context)
                  .textTheme
                  .button
                  .copyWith(color: PsColors.textPrimaryLightColor) :Theme.of(context)
                  .textTheme
                  .button),
        )
      ),
      Align(
        ...
        child: Padding(
          padding: const EdgeInsets.fromLTRB(12,4,12,12),
          child: Text(
              Utils.getString(context, 'label__municipality')
          ),
        ),
      ),
      Container(
          ...
          child: TextField(
            ...
            onTap: () {
              if(districtId != 0) {
                _municipalityDialog(productStateId);
//                if(stringStateId == 'itm_locc91e7fd5ffc739b26951228b0a564569') {
//                  _municipalityDialog(productStateId);
//                }else if (stringStateId == 'itm_loc892e3dbe2fbf07ae7b19455a4e75b28c') {
//                  _municipalityDialog(2);
//                }else if (stringStateId == 'itm_loca7b66748e03d457e976ca63a50e1bde0') {
//                  _municipalityDialog(3);
//                }
//                else if (stringStateId == 'itm_loc385aa4e50e654df21b9de999273c0a2c') {
//                  _municipalityDialog(4);
//                }
//                else if (stringStateId == 'itm_loc413981c0f76ad269307aaee5eff59517') {
//                  _municipalityDialog(5);
//                }
//                else if (stringStateId == 'itm_locb0f1625541a5cdebaf354c027b8462ee') {
//                  _municipalityDialog(6);
//                }
//                else if (stringStateId == 'itm_loc94a5a8f9492d0a5ec93165f0f639695d') {
//                  _municipalityDialog(7);
                }
                else {
                  Fluttertoast.showToast(
            ...
            decoration: InputDecoration(
                border: InputBorder.none,
                hintText: municipalityText == null ? Utils.getString(context, 'label__municipality') : municipalityText,
                hintStyle: municipalityText == null ? Theme.of(context)
                    .textTheme
                    .button
                    .copyWith(color: PsColors.textPrimaryLightColor) :Theme.of(context)
                    .textTheme
